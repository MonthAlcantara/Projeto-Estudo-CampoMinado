package io.github.monthalcantara.cm.modelo;
...
public class CampoTest {
    ...
    @Test
    @DisplayName("Deve alternar a marcação do campo")
    ...
    @Test
    @DisplayName("Deve alternar a marcação do campo duas vezes")
    void testeAlternaMarcadoDuasChamadas(){
        campo.alternarMarcacao();
        campo.alternarMarcacao();
